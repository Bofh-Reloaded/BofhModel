...
def test_lookups():
    ...
    graph.add_token(1, "0x0e09fabb73bd3ade0a17ecc321fd13a19e81ce82", "PancakeSwap Token", "Cake", 18, True, 0)
    graph.add_token(2, "0xe9e7cea3dedca5984780bafc599bd69add087d56", "BUSD Token", "BUSD", 18, True, 0)
    graph.add_token(3, "0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd", "Wrapped-BNB", "WBNB", 18, True, 0)
